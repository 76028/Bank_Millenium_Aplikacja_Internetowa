    ...
    <main>
        ...
        <section class="glowna">
            <ul class="nav nav-pills navkarty">
                ...
                <li class="nav-item navkarty">
                    <a class="nav-link active" href="kartyprzedplacone.php">Karta Przedpłacona</a>
                </li>
                <li class="nav-item navkarty">
                    <a class="nav-link" href="kartywirtualne.php">Karta wirtualna</a>
                </li>
            </ul>
            <h2 class="section kolorpaskow">Karta Przedpłacona</h2>
            <div class="row">
                <div class="col-md-6 ml-auto mr-auto">
                    <article class="karty" style="margin-top: 20px;">
                        <h5 class="karty">Millennium Mastercard Prepaid</h5>
                        <img src="img/karta9.jpg" width="500" height="500" alt="zdjecie" class="kartyzdjecia img-fluid">
                        <div class="card opiskont">
                            <ul>
                                <li>doskonały pomysł na prezent lub elektroniczne kieszonkowe</li>
                                <li>możliwość wielokrotnego zasilania</li>
                            </ul>
                        </div>
                    </article>
                </div>
